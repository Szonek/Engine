...
ENGINE_API engine_children_component_t engineGetChildrenComponent(engine_game_object_t game_object);
ENGINE_API bool engineHasChildrenComponent(engine_game_object_t game_object);
#ifdef __cplusplus
}
#endif  // #ifndef __cplusplus